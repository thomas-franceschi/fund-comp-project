...
class Flyingtype : public Pokemon {
	...
	public:
	Flyingtype( string name = "none", int max_hit_points = 75, int hit_points = 45, int attack = 45, int defense = 50, int level = 3, int evolve_level = 12, int exp = 10, int strengths = 0, int weaknesses = 0 );
